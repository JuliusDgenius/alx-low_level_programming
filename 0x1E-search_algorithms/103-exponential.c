 ...
 */
int binary_search_index1(int *array, size_t left, size_t right, int value)
{
	size_t m;
	...
	if (value < *(array + m))
	{
		return (binary_search_index1(array, left, m - 1, value))	;
	}
	...
	{
		return (binary_search_index1(array, m + 1, right, value));
	}
}
